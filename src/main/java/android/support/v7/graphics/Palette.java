...
public final class Palette {
    ...
    private static void checkBitmapParam(BufferedImage  bitmap) {
        if (bitmap == null) {
    ...
    public static final class Swatch {
        ...
        Swatch(int rgbColor, int population) {
            mRed = ColorUtils.red(rgbColor);
            mGreen = ColorUtils.green(rgbColor);
            mBlue = ColorUtils.blue(rgbColor);
            mRgb = rgbColor;
        ...
        Swatch(int red, int green, int blue, int population) {
            ...
            mGreen = green;
            mBlue = blue;
            mRgb = ColorUtils.rgb(red, green, blue);
            mPopulation = population;
        }
